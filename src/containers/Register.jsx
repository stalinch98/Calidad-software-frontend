  ...
  return (
    <section className="register">
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <label>
          Hombre
          <input {...register('genero')} type="radio" name="genero" value="hombre" />
        </label>
        <label>
          Mujer
          <input {...register('genero')} type="radio" name="genero" value="mujer" />
        </label>
        <label>
          Prefiero no decir
          <input {...register('genero')} type="radio" name="genero" value="no decir" />
        </label>
        <label>Estado Civil</label>
        <label>
          Soltero
          <input {...register('estadoCivil')} type="radio" name="estadoCivil" value="Soltero" />
        </label>
        <label>
          Casado
          <input {...register('estadoCivil')} type="radio" name="estadoCivil" value="Casado" />
        </label>
        <label>
          Divorciado
          <input {...register('estadoCivil')} type="radio" name="estadoCivil" value="Divorciado" />
        </label>
        <label>
          Viudo
          <input {...register('estadoCivil')} type="radio" name="estadoCivil" value="viudo" />
        </label>
        <input type="submit" />
      </form>
    </section>
